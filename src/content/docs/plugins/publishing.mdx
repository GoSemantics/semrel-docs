...
5. **Prepare registry metadata**
   ...
   **Option A — Community submission (recommended for external plugins):**
   Submit via the registry web UI at [registry.semrel.io/submit](https://registry.semrel.io/submit). Your plugin will be queued for maintainer review.
...
- [Plugin Registry](https://registry.semrel.io) — browse all published plugins
- [Submit a plugin](https://registry.semrel.io/submit) — community submission form
- [Registry API](https://registry.semrel.io/api/v1/plugins) — machine-readable JSON
