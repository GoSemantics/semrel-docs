...
Today, the machine-readable registry is served from GitHub Pages via the `semrel-registry` repository:

- Registry index: [https://semrels.github.io/semrel-registry/plugins.json](https://semrels.github.io/semrel-registry/plugins.json)
- Source repository: [SemRels/semrel-registry](https://github.com/SemRels/semrel-registry)

<Aside type="note">
  The `registry.semrel.io` custom domain is being set up. Until that is ready, the GitHub Pages URL above is the source of truth.
</Aside>
