---
title: Installation
description: How to install semrel on Linux, macOS, Windows — and via Docker in CI/CD.
---
...
<Tabs>
  ...
  <TabItem label="Binary download">
    Download the pre-built binary for your platform from [GitHub Releases](https://github.com/SemRels/semrel/releases) and place it somewhere on your `$PATH`:

    ```bash
    # Linux / macOS (example for v0.2.0, amd64)
    curl -L https://github.com/SemRels/semrel/releases/download/v0.2.0/semrel_0.2.0_linux_amd64.tar.gz \
      | tar xz semrel
...
<Aside type="tip">
  **Pin your image version in production.** Use `ghcr.io/semrels/semrel:0.2.0-alpine` instead of `latest` to ensure reproducible releases.
